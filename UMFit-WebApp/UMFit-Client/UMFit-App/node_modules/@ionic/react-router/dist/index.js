...
class ViewStacks {
    ...
    findViewInfoByLocation(location, viewKey) {
        ...
        function matchView(v) {
            ...
            const myMatch = reactRouterDom.matchPath(location.pathname, matchProps);
            if (myMatch) {
                view = v;
                match = myMatch;
                return true;
    ...
    syncRoute(routerOutlet) {
        ...
        React.Children.forEach(ionRouterOutlet.props.children, (child) => {
            for (const routeKey in this.routes) {
                ...
                if (((route.props.path || route.props.from) === (child.props.path || child.props.from)) &&
...
class IonReactMemoryRouter extends React.Component {
    render() {
        const _a = this.props, { children, history } = _a, props = tslib.__rest(_a, ["children", "history"]);
        const match = reactRouter.matchPath(history.location.pathname, this.props);
        return (React.createElement(reactRouter.MemoryRouter, Object.assign({}, props),
